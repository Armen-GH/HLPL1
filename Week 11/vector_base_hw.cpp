...
template<typename T, typename A> our_vector<T, A>& our_vector<T, A>::operator=(const our_vector<T, A>& vec) {                                                      //copy assignment
	if (this == &vec)
		return *this;
...
template<typename T, typename A> 
void our_vector<T, A>::reserve(int newalloc) {		
